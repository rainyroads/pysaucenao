...
setup(
        ...
        version='1.5.0',  # Start with a small number and increase it with every change you make
        ...
        download_url='https://github.com/FujiMakoto/pysaucenao/archive/1.5.0.tar.gz',
